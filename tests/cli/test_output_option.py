...
#: Commands that still take `--json` alone. `show` belongs to a different work stream's file;
#: anything else appearing here means a new command skipped `OutputOption`.
KNOWN_GAPS = {"show"}
