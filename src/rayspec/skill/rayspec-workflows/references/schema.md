<!-- Generated from docs/schema.md by scripts/gen_skill.py — do not edit here. -->
<!-- Canonical source: https://github.com/rayspec-labs/rayspec-py/blob/main/docs/schema.md -->
...
> [providers.md § Giving an agent a secret](https://github.com/rayspec-labs/rayspec-py/blob/main/docs/providers.md#giving-an-agent-a-secret-tools-not-prompts),
...
in [providers.md](https://github.com/rayspec-labs/rayspec-py/blob/main/docs/providers.md#access-levels-and-tools).
...
[runs-and-resume.md](https://github.com/rayspec-labs/rayspec-py/blob/main/docs/runs-and-resume.md#approval-gates).
...
`stream` (`stream.jsonl`); see [cli.md → `rayspec schema`](https://github.com/rayspec-labs/rayspec-py/blob/main/docs/cli.md#rayspec-schema). They are
checked in under [`schemas/`](https://github.com/rayspec-labs/rayspec-py/blob/main/schemas) and regenerated by
