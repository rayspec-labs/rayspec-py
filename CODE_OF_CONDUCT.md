...
The text above is the Contributor Covenant, unchanged apart from the contact
method. rayspec has one maintainer and no separate conduct mailbox, so the
channel is GitHub's private reporting form for this repository: it reaches the
